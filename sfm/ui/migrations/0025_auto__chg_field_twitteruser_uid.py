...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TwitterUser.uid'
        db.alter_column(u'ui_twitteruser', 'uid', self.gf('django.db.models.fields.BigIntegerField')(unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'TwitterUser.uid'
        db.alter_column(u'ui_twitteruser', 'uid', self.gf('django.db.models.fields.BigIntegerField')(default=0, unique=True))
