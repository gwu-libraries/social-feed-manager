...
- Developers responsible for the app include Dan Chudnov (`@dchud <http://twitter.com/dchud/>`_), Dan Kerchner (`@dankerchner <http://twitter.com/dankerchner/>`_), and Ankushi Sharma (`@anksharm <http://twitter.com/anksharm/>`_), 
